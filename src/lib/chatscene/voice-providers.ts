...
export const PROVIDER_CAPABILITIES: Record<string, VoiceProviderCapabilities> = {
  ...
  "lovable-ai": { languages:["pt-BR"],maxCharacters:600,controls:{speed:true,pitch:false,energy:false,expressiveness:true,roughness:false,warmth:false,brightness:false,emotion:true},costEstimate:false,local:false },
};
