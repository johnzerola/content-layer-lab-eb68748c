...
export interface EditorRenderManifestV2 {
  ...
  visualClips: { id: string; name: string; assetId?: string; audioGroupId?: string; trackId: string; kind: string; enabled: boolean; projectStart: number; projectEnd: number; sourceIn: number; sourceOut: number; playbackRate: number; reversed?: boolean; flipHorizontal?: boolean; flipVertical?: boolean; audio?: ClipAudioSettings; transform?: ClipTransform; style?: ClipStyle; metadata?: Record<string, unknown>; animations: EditorProjectV2["tracks"][number]["clips"][number]["animations"]; effects: EditorProjectV2["tracks"][number]["clips"][number]["effects"]; adjustments?: EditorProjectV2["tracks"][number]["clips"][number]["adjustments"]; motion?: EditorProjectV2["tracks"][number]["clips"][number]["motion"]; sticker?: EditorProjectV2["tracks"][number]["clips"][number]["sticker"] }[];
