    ...
    <section className="editor-v2-timeline flex h-full min-h-0 flex-col" aria-label="Timeline multitrack">
      <header className="editor-v2-timeline-toolbar flex h-11 shrink-0 items-center gap-1 px-2 sm:px-3">
        ...
        <Popover open={layerOpen} onOpenChange={setLayerOpen}>
          <PopoverTrigger asChild><button type="button" aria-expanded={layerOpen} className={`editor-tool-button ${layerOpen ? "text-primary" : ""}`}><Layers3 className="size-3.5" /><span className="hidden xl:inline">Camada</span><ChevronDown className="size-3" /></button></PopoverTrigger>
